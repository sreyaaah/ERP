...
const EditQuotation = ({ quotation, onSuccess }: EditQuotationProps) => {
  ...
  const [quotationType, setQuotationType] = useState<"international" | "interstate" | "intrastate">("intrastate");
  ...
  useEffect(() => {
    if (!quotation) {
      // Reset form when no quotation
      setQuotationNumber("");
      setReferenceNo("");
      setDate(new Date());
      setValidityDate(new Date());
      setText("");
      setQuotationType("intrastate");
      setCustomerSearch("");
  ...
  const getDefaultTaxByQuotationType = (type: "international" | "interstate" | "intrastate") => {
                        ...
                        <div className="d-flex gap-5">
                          <div className="form-check">
                            <input
                              ...
                              onChange={(e) =>
                                setQuotationType(e.target.value as "international" | "interstate" | "intrastate")
                              }
                            />
                            <label className="form-check-label" htmlFor="interstate-edit">
                              Interstate
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="intrastate-edit">
                              Intrastate
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            />
                            <label className="form-check-label" htmlFor="international-edit">
                              International
                            </label>
                          </div>
                        </div>
