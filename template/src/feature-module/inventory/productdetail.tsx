        ...
        <div className="content">
          <div className="page-header justify-content-between">
            ...
            <div className="page-btn d-flex align-items-center">
              <Link to={`/edit-product/${product.id}`} className="btn btn-outline-primary me-2 d-flex align-items-center">
              ...
              <Link to="/product-list" className="btn btn-added d-flex align-items-center">
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <span className={`badge ${product.status === "Available" ? "badge-linesuccess" : "badge-linedanger"}`}>
                      {product.status}
                    </span>
                  </div>
                  ...
                  <div className="row mb-4">
                    ...
                    <div className="col-md-6 mb-3">
                      <p className="text-muted mb-1">Selling Price (After Tax)</p>
                      <h6 className="fw-bold fs-18 text-success">₹{product.priceAfterTax}</h6>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <h6 className="fw-semibold">{product.taxType || "N/A"}</h6>
                    </div>
                    <div className="col-md-4 mb-3">
                    ...
                    <div className="col-md-4 mb-3">
                      ...
                      <h6 className="fw-semibold text-secondary">₹{product.priceBeforeTax}</h6>
                    </div>
                  </div>
                          ...
                          .map(([key, value]) => {
                            let displayValue =
                              value && typeof value === "object"
                                ...
                                : (value as string) || "N/A";
                            if (
                              (key === "manufacturedDate" || key === "expiryDate") &&
                              typeof value === "string" &&
                              value.includes("T")
                            ) {
                            ...
                            return (
                              <div className="col-md-4 mb-3" key={key}>
                                ...
                                <h6 className="fw-semibold">{displayValue}</h6>
                              </div>
                            );
                          })}
                      </div>
              ...
              <div className="page-wrapper-new p-0">
                <div className="content p-5 px-3 text-center">
                  ...
                  <p className="mb-0 fs-16">
                    ...
                    <strong>{product?.product}</strong>? This action cannot be undone.
                  </p>
